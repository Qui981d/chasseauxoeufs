...
const ENIGMAS = [
    ...
    },
    {
        ...
        emoji: '🎨',
        commerce: 'Mprint',
        riddle: 'Je donne forme à vos idées, sur papier comme ailleurs, du plus simple au plus coloré. Qui suis-je\u00a0?',
        isBonus: false,
    },
    {
        id: 10,
        emoji: '🥐',
        commerce: 'Kiosque',
        riddle: 'On ne reste jamais longtemps chez moi, mais on y passe souvent pour un petit plaisir du quotidien. Qui suis-je\u00a0?',
        isBonus: false,
    },
    {
        id: 11,
